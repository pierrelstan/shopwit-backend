...
function AuthLinks({
  ...
  fetchAllCarts.current = () => {
    ...
    allCarts(userId, cancelToken);
  };
  fetchAllFavorites.current = () => {
    const source = axios.CancelToken.source();
    const cancelToken = source.token;
    allFavorites(userId, cancelToken);
  };
  React.useEffect(() => {
    const source = axios.CancelToken.source();
  ...
  return (
    <React.Fragment>
        ...
        <Box>
          ...
          <div onClick={handleClose}>
            ...
            >
              ...
              <MenuItem component={RouterLink} to='/myproducts'>
                My Products
              </MenuItem>
      ...
      <Cart
        open={cart}
        style={{
          display: `${cart ? 'none' : 'none'}`,
        }}
      />

      <FavoritesItem
        openF={favOpenOrClose}
        style={{
          display: `${cart ? 'none' : 'none'}`,
        }}
      />
